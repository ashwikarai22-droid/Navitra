...
🛠️ Tech Stack
Frontend: Next.js 15+ (React 19), Tailwind CSS v4, Lucide React for elegant icons.
...
Install dependencies: This project uses a workspace setup. The main web application is located in apps/web.

npm install
# or install specifically on the web app:
# cd apps/web && npm install
Environment Variables: Create a .env file in the root of the project (or inside apps/web) based on .env.example.
